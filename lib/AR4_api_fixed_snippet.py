...
class AR4(object):
    ...
    def open(self, auto_calibrate: bool = False):
        ...
        self.startup(auto_calibrate=auto_calibrate)
    ...
    def startup(self, auto_calibrate: bool = False):
        ...
        # Optional: auto-calibrate on connect
        ...
        # Attempt to get position but don't crash if robot is at a limit
        ...
        try:
            ...
            logging.warning("Could not get position on startup: " + str(e))

            print("Warning: could not read position on startup (robot may be at a limit). Continuing...")
    ...
    def parse_response(self, response):
        ...
        # If response is an error, handle it and bail out
    ...
    def _build_default_calibration(self):
        ...
        cal[6]='0'; cal[7]='0'; cal[8]='0'; cal[9]='0'; cal[10]='0'; cal[11]='0'

        cal[12]='COM3'; cal[13]=''; cal[28]=0.0; cal[29]=0.0; cal[30]=0.0

        cal[22]='0'; cal[23]='0'; cal[24]='0'; cal[25]='0'; cal[26]='0'; cal[27]='0'

        cal[31]=''; cal[32]=''

        cal[47]='0'; cal[48]='0'; cal[49]='0'; cal[50]='0'; cal[51]='0'; cal[52]='0'

        cal[53]=''; cal[54]=''; cal[55]='1'; cal[56]='1'; cal[57]='1'

        cal[58]='1'; cal[59]='1'; cal[60]='1'

        cal[61]='0'; cal[62]='0'; cal[63]='0'; cal[64]='0'; cal[83]='1'

        cal[133]='170'; cal[134]='-170'; cal[135]='90'; cal[136]='-90'

        cal[137]='52'; cal[138]='-89'; cal[139]='165'; cal[140]='-165'

        cal[141]='105'; cal[142]='-105'; cal[143]='155'; cal[144]='-155'

        cal[145]='44.444'; cal[146]='55.555'; cal[147]='55.555'

        cal[148]='42.222'; cal[149]='21.333'; cal[150]='21.333'

        cal[151]='400'; cal[152]='400'; cal[153]='400'

        cal[154]='400'; cal[155]='400'; cal[156]='400'

        cal[157]='4000'; cal[158]='4000'; cal[159]='4000'

        cal[160]='4000'; cal[161]='4000'; cal[162]='4000'
    ...
    def load_calibration(self):
        ...
        try:
            ...
            if not isinstance(calibration, list) or len(calibration) < 188:

                raise ValueError("Invalid calibration file")

        except Exception as e:

            print("No valid calibration file found - using defaults")

            logging.info("No valid calibration file found - using defaults")

            logging.info(str(e))

            calibration = self._build_default_calibration()
    ...
    def set_com_gripper(self, port):
        ...
        try:
            ...
            self.ser2 = serial.Serial(port, 115200)

            print("COMMUNICATIONS STARTED WITH ARDUINO IO BOARD")
    ...
    def cal_robot_all(self):
        ...
        if response[:1] == 'A':
            ...
            print("Auto Calibration Stage 1 Failed")

            self.error_handler(response)

 

        cal_stat_val2 = sum(int(self.calibration[f'J{j}CalStatVal2']) for j in range(1, 7))
        ...
        if cal_stat_val2 > 0:
            ...
            if response[:1] == 'A':
                ...
                print("Auto Calibration Stage 2 Failed")
    ...
    def cal_robot_joint(self, joint: int):
        ...
        try:
            ...
            if response[:1] == 'A':
                ...
                print("J" + str(joint) + " Calibration Failed")
    ...
    def move_l(self, x, y, z, rx, ry, rz, j7=0.0, j8=0.0, j9=0.0,
        ...
        command = ("MLX{:.3f}Y{:.3f}Z{:.3f}Rz{:.3f}Ry{:.3f}Rx{:.3f}".format(x, y, z, rz, ry, rx)
                   ...
                   + "Rm" + str(acc_ramp) + "Rnd" + str(rnd) + "W" + wrist_config + "Lm" + self.loop_mode
    ...
    def move_c(self, x_center, y_center, z_center, rx, ry, rz,
        ...
        command = ("MJ" + "X{:.3f}Y{:.3f}Z{:.3f}".format(x_start, y_start, z_start)
                   ...
                   + "Dc" + str(deceleration) + "Rm" + str(acc_ramp) + "W" + wrist_config + "Lm" + self.loop_mode + "\n")
    ...
    def move_a(self, x, y, z, rx, ry, rz, x_end, y_end, z_end, tr_val,
        ...
        command = ("MA" + "X{:.3f}Y{:.3f}Z{:.3f}Rz{:.3f}Ry{:.3f}Rx{:.3f}".format(x, y, z, rz, ry, rx)
                   ...
                   + "Ex{:.3f}Ey{:.3f}Ez{:.3f}Tr{:.3f}".format(x_end, y_end, z_end, tr_val)
    ...
    def set_io_arduino(self, output, state):
        ...
        command = ("ONX" if state else "OFX") + str(output) + "\n"
        ...
        if response[1:2] == 'L':
            ...
            for i, axis in enumerate(response[2:11], start=1):
                ...
                if axis == '1':
                    ...
                    msg = "J" + str(i) + " Axis Limit"

                    print(msg); logging.error(msg + ": " + response)
            ...
            for i, axis in enumerate(response[2:8], start=1):
                ...
                if axis == '1':
                    ...
                    msg = "J" + str(i) + " Collision or Motor Error"
            ...
            msg = "Position Out of Reach"

            print(msg); logging.error(msg + ": " + response)

        elif response[1:2] == 'S':

            msg = "Spline Can Only Have Move L Types"

            print(msg); logging.error(msg + ": " + response)

        elif response[1:2] == 'G':

            msg = "Gcode file not found"
            ...
            msg = "E stop Button was Pressed"

            print(msg); logging.error(msg + ": " + response)

        elif response[1:2] == 'A':

            msg = "J" + response[2:3] + " CALIBRATION ERROR"
    ...
    def save_pos_data(self):
        ...
        # Save current position state to a separate file - never overwrites ARbot.cal

        try:

            pickle.dump(self.calibration, open("ARbot_posstate.pkl", "wb"))

        except Exception as e:

            logging.warning("Could not save position state: " + str(e))